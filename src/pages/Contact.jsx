        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="glass rounded-3xl shadow-2xl p-8 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 btn-modern"
              >
                Send Message
              </button>
            </form>
